...
setup(
    ...
    scripts=[
        "softchord.py"
    ],  #, "softchord_main_window_ui.py", "softchord_chord_dialog_ui.py", "softchord_pdf_dialog_ui.py"],
    data_files=[
    ...
    zipfile=
    None,  # Include the libraries in the executable itself instead of creating a separate archive file.
